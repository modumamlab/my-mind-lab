...
(function(global){
  ...
  const build = '20260903-rc3-30-tci-structured-data-v1';
  ...
  const workspaces = [
    ...
    },
    {
      ...
      src:'./js/modules/assessment-reports.js?v=20260903-rc3-30-tci-structured-data-v1',
      required:true,
      dependsOn:['data-store','print-engine']
    },
    {
      id:'operations-workspace',
      src:'./js/modules/operations-workspace.js?v=20260903-rc3-30-tci-structured-data-v1',
      required:true,
  ...
  const startup = [
    {
      id:'admin-main',
      src:'./js/admin.js?v=20260903-rc3-30-tci-structured-data-v1',
      required:true
    },
    {
