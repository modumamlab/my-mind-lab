function chooseMode(state, aiMessages) {
  ...
  if (!state.duration) return "gentle_question";
...
function buildDirectorNote(mode) {
  const notes = {
    warm_reflection: "처음 나온 이야기를 크게 해석하지 말고, 안전하게 받아 주세요. 질문은 꼭 필요할 때만 합니다.",
    ...
    no_question_hold: "직전 AI가 질문했으므로 이번에는 질문하지 말고 짧게 머물러 주세요.",
    plain_response: "어려운 상담 용어 없이 아주 자연스럽게 말하세요. '부담/흐름/영향/살펴보다' 표현을 피하세요.",
