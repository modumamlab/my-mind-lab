...
"현재 AI 사용량이 많아 마음리포트 연결이 원활하지 않습니다. 다만 남겨주신 내용을 보면 "${mindState}"와 관련된 고민이 느껴집니다.\n\n지금 내 마음 상태가 궁금하다면 아래 kanana AI 마음리포트를 이용해 주세요. 보다 전문적인 심리검사와 상담이 필요하시다면 상담 예약하기를 이용해 주세요."
  })
};
} catch (error) {
return {
